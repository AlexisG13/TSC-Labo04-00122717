...
enum parameters {ELEMENT_LENGTH,T,K,LAMBDA,V,TRIDENTE,ALPHA,DELTA,N};
...
class mesh{
    ...
    public:
        void setParameters(float l,float t,float k,float lambda,float v,float tridente,float alpha,float delta,float n){
            parameters[ELEMENT_LENGTH]=l;
            parameters[T]=t;
            parameters[K]=k;
            parameters[LAMBDA]=lambda;
            parameters[V]=v;
            parameters[TRIDENTE]=tridente;
